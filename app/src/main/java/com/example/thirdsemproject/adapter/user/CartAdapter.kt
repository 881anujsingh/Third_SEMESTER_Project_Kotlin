...
import com.example.mobileassignment.model.CartModel
import com.example.mobileassignment.model.CategoryModel
import com.example.mobileassignment.viewmodel.CartViewModel
...
class CartAdapter(var context: Context, var data:ArrayList<CartModel>, var cartViewModel: CartViewModel) : RecyclerView.Adapter<CartAdapter.CartViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartViewHolder {
        var view = LayoutInflater.from(parent.context)
            .inflate(R.layout.sample_cart, parent, false)
